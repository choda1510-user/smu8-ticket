...
export type AdminConcertCreateRequest = {
    ...
    startAt: string; // 등록 요청 body에 담아 보낼 공연 시작일시
    endAt: string; // 등록 요청 body에 담아 보낼 공연 종료일시
    reservationStartAt?: string; // 등록 요청 body에 담아 보낼 예매 오픈 시작일시
    reservationEndAt?: string; // 등록 요청 body에 담아 보낼 예매 종료일시
...
export type AdminConcertUpdateRequest = AdminConcertDetailRequest & {
    ...
    startAt: string; // 수정 요청 body에 담아 보낼 공연 시작일시
    endAt: string; // 수정 요청 body에 담아 보낼 공연 종료일시
    reservationStartAt?: string; // 수정 요청 body에 담아 보낼 예매 오픈 시작일시
    reservationEndAt?: string; // 수정 요청 body에 담아 보낼 예매 종료일시
